...
urlpatterns = [
	...
	path('employee_tax_regime/<int:pk>', api.update_employee_regime, name='update_employee_regime'),
	path('update_tax_slabs/<int:pk>', api.update_tax_slab, name='update_tax_slabs'),
