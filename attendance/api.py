...
def check_in_entry(request):
	employee_id = 9                #TODO have to get the employee_id token data
	today = date.today()
...
def get_employee_attendance_report(request,id):
	...
	# attendance_entries = employee_attendance.objects.
	# print("filter_by_date----->",filter_by_date.check_in,filter_by_date.check_out)
	...
	print("employee_info----->",employee_info.first_name,employee_info.last_name)
	attendance_data = employee_info.employeeid.all()
	attendance_info = employee_info.attendanceinfo_employeeid.all()
	# attendance_entries = employee_info.attendanceinfo_employeeid.attendanceid.all()
	attendance_entries = attendance_data[0].attendanceid.all()
	# entries = []
	# for entry in attendance_entries:
	# 	data = {
	# 		'checkin_entry':entry.checkin_entry,
	# 		'checkout_entry':entry.checkout_entry
	# 	}
	# 	entries.append(data)
	# 	print("entry---->",entry.checkin_entry,entry.checkout_entry)
...
# 	# attendance_entries = employee_attendance.objects.
# 	# print("filter_by_date----->",filter_by_date.check_in,filter_by_date.check_out)
# 	employee_info = employee.objects.prefetch_related(Prefetch('employeeid', queryset=filter_by_date),'attendanceinfo_employeeid').all()
# 	print("employee_info----->",employee_info.first_name,employee_info.last_name)
# 	attendance_data = employee_info.employeeid.all()
# 	attendance_info = employee_info.attendanceinfo_employeeid.all()
# 	# attendance_entries = employee_info.attendanceinfo_employeeid.attendanceid.all()
