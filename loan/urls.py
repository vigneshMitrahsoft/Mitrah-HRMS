...
urlpatterns = [
    ...
    path('',api.loan_list,name='loan_list'),
    path('<int:pk>',api.loan_detail_by_employee,name='loan_detail'),
    path('create',api.loan_create,name='loan_create'),
    path('update/<int:pk>',api.update_loan,name='loan_update'),
    path('delete/<int:pk>',api.loan_delete,name='loan_delete'),
    path('request_acceptance/<int:pk>',api.request_acceptance, name='loan_request_acceptance'),

    path('repayments',api.repayment_list,name='repayment_list'),
    path('repayments/<int:pk>',api.repayment_detail,name='repayment_detail'),
    path('repayments/create/<int:pk>', api.repayment_create, name ='repayment_create')
